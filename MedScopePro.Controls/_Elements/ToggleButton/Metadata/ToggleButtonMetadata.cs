using MedScopePro.Controls.SideMenu._Elements.ToggleButton;
using MedScopePro.Controls._Elements.ToggleButton.Generic;
using MedScopePro.Controls.TitleBar._Elements;
using MedScopePro.Controls.Icon.Enums;

namespace MedScopePro.Controls._Elements.ToggleButton.Metadata;
